...
; NAME:  Inside
; $Id$
; PURPOSE:  determine whether a given point is inside a polygon.
;
; AUTHOR:  David Fanning (I just stole it and made some small changes.)
;
; CATEGORY:  utility
;
; CALLING SEQUENCE:  
...
;    px: the x values of the polygon
;    py: the y values of the polygon.
;
; OPTIONAL INPUTS:  
;	
; KEYWORD PARAMETERS:  
