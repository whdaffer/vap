...
;
; CALLING SEQUENCE:  24bitColor=Color24(colorIndex [,ColorTable=ColorTable])
; 
; INPUTS:  
;  
...
FUNCTION color24, colors, colorTable=colorTable, transpose=transpose

  IF n_Params() LT 1 THEN BEGIN 
    Message,'usage: 24bitColors=color24( colors [,colortable=colortable])',/cont
    return,''
  ENDIF 
  colorCpy = colors
