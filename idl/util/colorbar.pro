...
;       transformation existed before the call to colorbar. If this
;       transformation is required after the call to colorbar.pro, it
...
PRO COLORBAR, BOTTOM=bottom, $  ; bottom color index
